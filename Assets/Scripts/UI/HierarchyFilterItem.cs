...
public class HierarchyFilterItem : MonoBehaviour
{
    ...
    public void Reset() 
    {
        ...
        InHierarchyToggle.graphic.GetComponent<GraphicThemeable>().ID = setting.InHierarchyToggleable 
            ? "ControlContent" : "Content1";
        ...
        InSearchResultToggle.graphic.GetComponent<GraphicThemeable>().ID = setting.InSearchResultToggleable 
            ? "ControlContent" : "Content1";
