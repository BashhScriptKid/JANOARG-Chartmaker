...
public class Modal : MonoBehaviour, IPointerDownHandler
{
    ...
    public void OnHeaderDragStart(BaseEventData eventData) => 
        OnHeaderDragStart((PointerEventData)eventData);
    ...
    public void OnHeaderDrag(BaseEventData eventData) => 
        OnHeaderDrag((PointerEventData)eventData);
